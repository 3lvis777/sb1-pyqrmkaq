        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full pr-10 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500"
              />
              <button
                type="button"
          ...
          <div className="flex justify-end space-x-3 mt-6">
            ...
            >
              {loading ? (
                <>
                  <Lock className="animate-spin -ml-1 mr-2 h-4 w-4" />
                  Updating...
                </>
              ) : (
                'Update Password'
